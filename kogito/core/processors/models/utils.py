...
class Evaluator:
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.metrics = dict(
            ...
            # (weighted)
            train_precision=torchmetrics.Precision(task="multiclass", num_classes=3, average="weighted"),
            train_recall=torchmetrics.Recall(task="multiclass", num_classes=3, average="weighted"),
            train_f1=torchmetrics.F1Score(task="multiclass", num_classes=3, average="weighted"),
            # (micro)
            train_precision_micro=torchmetrics.Precision(
                task="multiclass", num_classes=3, average="micro"
            ),
            train_recall_micro=torchmetrics.Recall(task="multiclass", num_classes=3, average="micro"),
            train_f1_micro=torchmetrics.F1Score(task="multiclass", num_classes=3, average="micro"),
            # (macro)
            ...
            val_f1_micro=torchmetrics.F1Score(task="multiclass", num_classes=3, average="micro"),
            # (macro)
            val_precision_macro=torchmetrics.Precision(task="multiclass", num_classes=3, average="macro"),
            ...
            test_f1_micro=torchmetrics.F1Score(task="multiclass", num_classes=3, average="micro"),
            # (macro)
            test_precision_macro=torchmetrics.Precision(task="multiclass", num_classes=3, average="macro"),
            test_recall_macro=torchmetrics.Recall(task="multiclass", num_classes=3, average="macro"),
            test_f1_macro=torchmetrics.F1Score(task="multiclass", num_classes=3, average="macro"),
            # (per class)
            test_precision_class=torchmetrics.Precision(task="multiclass", num_classes=3, average="none"),
            test_recall_class=torchmetrics.Recall(task="multiclass", num_classes=3, average="none"),
            test_f1_class=torchmetrics.F1Score(task="multiclass", num_classes=3, average="none"),
        )
