...
if __name__ == "__main__":
    ...
    wandb_logger = WandbLogger(
        ...
        name=f"distilbert_{emb_txt}_{MODEL_TYPE}_{DATASET_TYPE}",
    )
    ...
    trainer = pl.Trainer(
        default_root_dir="models/distilbert",
    ...
    trainer.save_checkpoint(
        f"models/distilbert/distilbert_model_{emb_txt}_{MODEL_TYPE}_{DATASET_TYPE}_{timestamp}.ckpt",
        weights_only=True,
    )
