...
from kogito.core.processors.models.swem import (
    SWEMConfig,
    SWEMClassifier,
    SWEMHeadDataset,
)
...
if __name__ == "__main__":
    ...
    wandb_logger = WandbLogger(
        project="kogito-relation-matcher", name=f"swem_{emb_txt}_{DATASET_TYPE}"
    )
    ...
    trainer.save_checkpoint(
        f"models/swem/swem_{emb_txt}_{DATASET_TYPE}_{timestamp}.ckpt", weights_only=True
    )
