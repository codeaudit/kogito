...
train_graph = KnowledgeGraph.from_csv(
    "data/atomic2020_data-feb2021/train.tsv", header=None, sep="\t"
)
val_graph = KnowledgeGraph.from_csv(
    "data/atomic2020_data-feb2021/dev.tsv", header=None, sep="\t"
)
test_graph = KnowledgeGraph.from_csv(
    "data/atomic2020_data-feb2021/test.tsv", header=None, sep="\t"
)
model.train(
